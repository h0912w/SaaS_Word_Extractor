#!/usr/bin/env python3
"""
Enhanced Challenge Reviewer with more comprehensive patterns
"""
...
class EnhancedChallengeReviewer:
    """Enhanced reviewer with more aggressive challenge patterns"""

    # Enhanced patterns for over-acceptance detection
    OVER_ACCEPT_PATTERNS = {
        'non_english': [
            ...
            # Italian
            r'^il$', r'^lo$', r'^gli$', r'^i$', r'^di$', r'^da$', r'^in$', r'^su$', r'^per$',
            # Common non-English words
            r'^que$', r'^corra$', r'^voz$', r'^clase$', r'^amor$', r'^luchar$',
            r'^em$', r'^ekat$', r'^ot$', r'^gnimoc$', r'^er\'yeht$',
            # Portuguese
            r'^para$', r'^como$', r'^onde$', r'^quando$',
        ],
        'too_generic': [
            ...
            r'^want$', r'^wanted$', r'^need$', r'^needed$', r'^like$', r'^liked$',
            r'^use$', r'^used$', r'^find$', r'^found$', r'^give$', r'^gave$', r'^given$',
            ...
            r'^way$', r'^ways$', r'^side$', r'^sides$', r'^right$', r'^left$',
            # Generic time
            r'^now$', r'^then$', r'^here$', r'^there$', r'^when$',
            # Very generic nouns
            r'^thing$', r'^things$', r'^something$', r'^anything$',
            r'^man$', r'^men$', r'^woman$', r'^women$', r'^person$', r'^people$',
            r'^good$', r'^bad$', r'^best$', r'^better$', r'^well$',
        ],
        'technical_jargon': [
            r'^pthread$', r'^mutex$', r'^semaphore$',
            r'^endianness$', r'^bytecode$', r'^opcode$',
            r'^syscall$', r'^kernel$', r'^alloc$',
            r'^endi$', r'^oem$',
        ],
        'noise_patterns': [
            # Filename patterns
            ...
            r'.*readme.*', r'.*\.bak$', r'.*\.tmp$', r'.*\.old$',
            # Version patterns
            r'^v\d+$', r'^\d+\.\d+$', r'^\d+\.\d+\.\d+$',
            r'^\d+st$', r'^\d+nd$', r'^\d+rd$', r'^\d+th$',
            # Alphanumeric codes (2-3 chars)
            r'^[a-z]\d$', r'^\d[a-z]$', r'^[a-z]\d[a-z]$',
            r'^\d{2,4}$',
            # Abbreviations/acronyms that are too short
            r'^(em|ot|ekat|gnimoc)$',
        ],
        'special_chars': [
            ...
            r'.*[ŋščžžýáéíóúàèìòùäëïöüãõñ¿¡«»§¶‡†].*',
            # Mixed hyphen-number patterns
            r'^.*-\d+.*$', r'^\d+.*-.*$',
        ],
        'reversed_text': [
            # Reversed English words (common in palindrome titles)
            r'^gnimoc$', r'^er\'yeht$', r'^yawa$',
        ]
    }
    ...
    def should_challenge(self, record: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Determine if a record should be challenged"""
        challenges = []
        ...
        if self.matches_pattern(word, 'reversed_text'):
            challenges.append({
                "reviewer_id": "challenge-reviewer-06",
                "challenged": True,
                "reason": f"Reversed text '{word}' from palindrome/string manipulation",
                "suggested_action": "reject"
            })
            self.challenge_stats['reversed_text'] += 1
    ...
    def process_file(self, input_path: str, output_path: str):
        ...
        # Print summary
        print(f"\n{'='*60}")
        print(f"Enhanced Challenge Review Summary")
        print(f"{'='*60}")
...
def main():
    ...
    reviewer = EnhancedChallengeReviewer()
